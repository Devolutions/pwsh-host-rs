...
internal sealed unsafe class PowerShellSessionHandle : SafeHandleZeroOrMinusOneIsInvalid
{
    internal PowerShellSessionHandle(ulong value)
    ...
    protected override bool ReleaseHandle()
    {
        ...
        int status = NativeMethods.ReleaseSession(unchecked((ulong)handle), &result);
    ...
    {
        private PowerShellSessionHandle? owner;

        internal HandleLease(PowerShellSessionHandle owner)
        {
            this.owner = owner;
        ...
        public void Dispose()
        {
            PowerShellSessionHandle? current = Interlocked.Exchange(ref owner, null);
